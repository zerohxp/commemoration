...
const Footer = function (tree, width, height, speed) {
  this.tree = tree;
...
const Tree = function (ctx, width, height, opt) {
  // this.canvas = canvas;
...
const Branch = function (tree, point1, point2, point3, radius, length, branchs) {
  this.tree = tree;
  this.point1 = point1;
  this.point2 = point2;
  this.point3 = point3;
